...
cmake -S $HOME_DIR -B $HOME_DIR/build -DBENCHMARK_BACKEND=VTUNE -DCALC_STATS=OFF -DCPUFREQ_MHZ=2100 -DDRAMHiT_VARIANT=2025 -DBUCKETIZATION=ON -DBRANCH=simd -DUNIFORM_PROBING=ON -DPREFETCH=L2
...
FILE_NAME=output.txt
    ...
    --num-threads $numThreads --seed 2190830198 --numa-split $numa_policy --no-prefetch 0 --mode $BW --ht-size $size --skew $skew\
    --hw-pref 0 --batch-len 16 --relation_r_size $rsize --scale_factor 1 --sequential 2"
