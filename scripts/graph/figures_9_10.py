...
if __name__ == '__main__':
    ...
    for n in [0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95, 0.99]:
        ...
        run_synchronous(cashtpp_home, './dramhit', ['--mode=11', '--ht-fill=75',
        ...
        run_synchronous(casht_home, './dramhit', ['--mode=11', '--ht-fill=75',
        ...
        run_synchronous(bq_home, './dramhit', ['--mode=8', '--ht-fill=75',
